        ...
        <WatchlistProvider>
          ...
          <div className="min-h-screen bg-black text-white">
            ...
            <footer className="border-t border-zinc-900 mt-16 py-6 px-4 text-center text-zinc-700 text-xs">
              ...
              <p className="mt-1">Anime data provided by <a href="https://anilist.co" target="_blank" rel="noopener noreferrer" className="text-zinc-500 hover:text-emerald-400 transition-colors">AniList</a>.</p>
            </footer>
            <BackToTop />
            <RateLimitBanner />
            <Toast />
